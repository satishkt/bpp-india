...
class PriceSpider(scrapy.Spider):
    ...
    start_urls = ['http://api.dataweave.in/v1/retail_prices_india/findByCityAndCommodity/?api_key=67fbcf2894171449d53099c1d3079956fe0dd8d8&city=%s&commodity=Tomato&start_date=20130101&end_date=20140101&page=1&per_page=1' %city for city in ['CHANDIGARH','DELHI','HISAR','KARNAL','SHIMLA','MANDI','SRINAGAR','JAMMU','AMRITSAR','LUDHIANA','BHATINDA','LUCKNOW','KANPUR','VARANASI','AGRA','DEHRADUN','RAIPUR','AHMEDABAD','RAJKOT','BHOPAL','INDORE','MUMBAI','NAGPUR','JAIPUR','JODHPUR','KOTA','PATNA','BHAGALPUR','RANCHI','BHUBANESHWAR','CUTTACK','GUWAHATI','SAMBALPUR','KOLKATA','SILIGURI','ITANAGAR','SHILLONG','AIZWAL','DIMAPUR','AGARTALA','HYDERABAD','VIJAYWADA','BENGALURU','ERNAKULAM','THIRUCHIRAPALLI']
                 ]
