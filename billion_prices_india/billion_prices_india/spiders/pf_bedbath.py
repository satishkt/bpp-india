...
class PepperFry(BasePepperFry):
    ...
    start_urls = ['http://www.pepperfry.com/bed-bath-%s.html' % s for s in
                  ['bed-sheets', 'combo-offers', 'bed-covers', 'duvet-covers', 'blankets-quilts', 'bedding-diwan-sets',
                   ...
                   'towel-holders','toilet-paper-holders', 'bathroom-tumblers', 'clothes-hooks', 'personal-grooming', 'soap-dishes',
                   ...
                   'sanitary-ware-floor-drains', 'sanitary-ware-cisterns', 'sanitary-ware-pipes-hoses', 'kids']].append(
        ['http://www.pepperfry.com/furnishings-curtains-shower-curtains.html',
