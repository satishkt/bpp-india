...
class PriceSpider(scrapy.Spider):
    ...
    name = "pc_gamingconsole"
    allowed_domains = ["pricecheckindia.com"]
    start_urls = ['http://api.pricecheckindia.com/feed/product/gaming_consoles.json?user=mandeepa&key=UPIFDOZVNPOVPFSF']
