...
class PriceSpider(scrapy.Spider):
    ...
    start_urls = ['http://pricedekho.com/bath-body/%s+bath-body-price-list.html' %s for s in ['adidas','anway','ambi','auravedic','avani','avon','ayur','bahor','biotique','boots','biobloom','canaan','brut','chicco','dalan','denim','everyuth','eraser','fabindia','fairbeat','gillette','godrej','himalaya','kaya','khadi','lakme','lilium','lotus','lux','madara','mothercare','neutrogena','nivea','olay','oxy','palmolove','pampers','philips','ponds','revlon','taashi','vlcc','yardley']]
    crawledURL = []
    detailedCrawled = []
    ...
    def parse(self, response):
        ...
        baseurl=self.__getHostURL(response.url)+"bath-body/"
