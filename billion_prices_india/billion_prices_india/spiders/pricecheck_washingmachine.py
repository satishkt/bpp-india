...
class PriceSpider(scrapy.Spider):
    ...
    name = "pc_washingmachine"
    allowed_domains = ["pricecheckindia.com"]
    start_urls = ['http://api.pricecheckindia.com/feed/product/washing_machines.json?user=mandeepa&key=UPIFDOZVNPOVPFSF']
