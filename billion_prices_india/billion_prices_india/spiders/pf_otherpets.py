...
class PepperFry(scrapy.Spider):
    ...
    name = "pf_otherpetsupply"
    start_urls = ['http://www.pepperfry.com/pet-supplies-%s.html' % s for s in
                  ['birds', 'small-animals', 'pot-planters', 'plants-bulbs', 'seeds', 'vases', 'artificial-flowers',
                   'gardening-tools', 'watering-equipment']].append(
        'http://www.pepperfry.com/pets-and-gardening-garden-decor.html')
