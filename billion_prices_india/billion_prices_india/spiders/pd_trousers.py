...
class PriceSpider(scrapy.Spider):
    ...
    start_urls = ['http://pricedekho.com/trousers/%s+trousers-price-list.html' %s for s in ['arrow','basics','btwin','chemistry','chicco','elle','highlander','lee','nineteen','raymond','wrangler','yepme']]
    crawledURL = []
    detailedCrawled = []
    ...
    def parse(self, response):
        ...
        baseurl=self.__getHostURL(response.url)+"trousers/"
