...
class PriceSpider(scrapy.Spider):
    ...
    start_urls = ['http://pricedekho.com/t-shirts/%s+t-shirts-price-list.html' %s for s in ['adidas','nike','reebok','duke','wrangler','benetton','bossini','chicco','chemistry','diva','disney','elle','hanes','killer','lee','marvel','nun','puma','rangoli','softwear','tweety','ucla','usi','yonex','yepme']]
    crawledURL = []
    detailedCrawled = []
    ...
    def parse(self, response):
        ...
        baseurl=self.__getHostURL(response.url)+"tshirts/"
