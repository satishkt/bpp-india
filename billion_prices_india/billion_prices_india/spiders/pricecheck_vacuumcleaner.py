...
class PriceSpider(scrapy.Spider):
    ...
    name = "pc_vacuumcleaner"
    allowed_domains = ["pricecheckindia.com"]
    start_urls = ['http://api.pricecheckindia.com/feed/product/vacuum_cleaners.json?user=mandeepa&key=UPIFDOZVNPOVPFSF']
