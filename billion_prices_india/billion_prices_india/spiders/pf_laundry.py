...
class PepperFry(scrapy.Spider):
    ...
    name = "pf_laundry"
    start_urls = ['http://www.pepperfry.com/laundry-housekeeping-%s.html' % s for s in
                  ['laundry-baskets','cloth-dryers','ironing-boards-covers','buckets-tubs','detergents-chemicals']]
