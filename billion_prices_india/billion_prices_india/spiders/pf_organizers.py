...
class PepperFry(scrapy.Spider):
    ...
    name = "pf_organizers"
    start_urls = ['http://www.pepperfry.com/laundry-housekeeping-organisers-%s.html' % s for s in
                  ['cloth-organisers', 'racks-cabinets', 'bins-boxes', 'organisers-baskets', 'organisers-trays',
                   'organisers-racks', 'purse-organisers', 'shoe-organisers', 'jewellery-organisers',
                   'document-organisers', 'other-organisers']].append(
        ['http://www.pepperfry.com/housekeeping-vacuum-cleaners.html',
         'http://www.pepperfry.com/laundry-housekeeping-hooks-hangers.html',
         'http://www.pepperfry.com/laundry-housekeeping-tools-hardware.html',
         'http://www.pepperfry.com/housekeeping-handles-knobs.html',
         'http://www.pepperfry.com/housekeeping-door-knockers-bells.html',
         'http://www.pepperfry.com/laundry-housekeeping-step-ladders-stools.html',
         'http://www.pepperfry.com/housekeeping-mosquito-nets.html',
         'http://www.pepperfry.com/housekeeping-utility-weighing-scales.html',
         'http://www.pepperfry.com/laundry-housekeeping-umbrellas.html',
         'http://www.pepperfry.com/laundry-housekeeping-shopping-trolleys.html',
         'http://www.pepperfry.com/housekeeping-home-safes.html',
         'http://www.pepperfry.com/housekeeping-door-bolt-locks.html',
         'http://www.pepperfry.com/housekeeping-locks.html',
         'http://www.pepperfry.com/laundry-housekeeping-electrical-accessories.html',
         'http://www.pepperfry.com/laundry-housekeeping-insect-rodent-repellents.html']
    )
