...
class PriceDekhoMobileSpider(scrapy.Spider):
    name = "PriceDekhoMobile"
    domain_name = "pricedekho"
    ...
    def __init__(self, category=None, brand=None, *args, **kwargs):
        super(PriceDekhoMobileSpider, self).__init__(*args, **kwargs)
        #self.brand = brand.lower()
        #self.category = category.lower()
        self.baseURL = 'http://www.%s.com/%s/' % (self.domain_name, self.category)
        print(self.baseURL)
