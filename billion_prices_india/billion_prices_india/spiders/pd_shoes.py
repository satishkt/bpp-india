...
class PriceSpider(scrapy.Spider):
    ...
    start_urls = ['http://pricedekho.com/shoes/%s+shoes-price-list.html' %s for s in ['nike','puma','reebok','woodland','adidas','converse','bata','barbie','batman','balls','ego','froggy','inesis','isabelle','jaspo','kiale','lotto','martini','mkb','nineteen','nivia','raw','roxy','skin','tiptopp','vans','yonex','zuicy']]
    crawledURL = []
    detailedCrawled = []
    ...
    def parse(self, response):
        ...
        baseurl=self.__getHostURL(response.url)+"shoes/"
